        ...
        <div class="container section">
          ...
          <h2>ORDER SUMMARY</h2><HR>
            ...
            <div class="col-lg-7" style="color: #000;">
             <P>Mr XYZ ABD <br>
| Address XXX c XXXX V CFC VVVVVVVVVVVV CCCC | <br>
|9873412345 | XYZABC@ABHC.COM | </P><br><br>
<img src="images/space.png"> <br><br> </div>  <div class="col-lg-5"></div>
<div class="col-lg-7" style="color: #000;">
<p>ZEPHYR BOX <BR>
|INTERIOR | RESIDENTIAL | LIVING, KITCHEN | <BR>
|ETHENIC THEME | 0-250 SQ FT AREA | 0-50000 BUDGET |</p>
            ...
            <div class="col-lg-5 totals-group">
              ...
              <div class="totals-content">
                <div class="subtotal-group">
                  <h6>INR 7,0000 X PRICE MULTIPER 2 =</h6>
        ...
        <!-- ========== Related Items - (products section) ========== -->
          ...
          <div class="container section">
            ...
            <div class="row">
              ...
              <!-- Shop Product -->
              <div class="col-lg-8">
                <h3>Order No - XXVXCEDECV</h3><br><br><br>
                <p style="color: #000;">GST REGISTRATION No:- 27AETPA2229J1ZE</p>
              </div><!-- / .col-lg-7 -->
              <div class="col-lg-4 totals-group">
                <div class="totals-content">
                <div class="subtotal-group">
                  <h6>TOTAL <small>(before taxes)</small></h6>
                  &nbsp &nbsp &nbsp<input type="text" style="width:100px;"  readonly; ><br>
                  <h6>(+) TAXES <small> (GST @18%)</small></small></h6>
                   &nbsp &nbsp<input type="text" style="width:100px;"  readonly; ><br>
                  <h6>(-) PROMO CODE</h6>
                 &nbsp &nbsp &nbsp &nbsp <input type="text" style="width:100px;"  readonly; ><br>
                </div>
                </div>
              </div><!-- / .col-lg-5 -->
          ...
          <div class="container section">
            ...
            <div class="row">
              ...
              <div class="col-lg-4 totals-group">
                ...
                <div class="subtotal-group">
                  <h6>NET TOTAL</h6>
                  &nbsp &nbsp &nbsp<input type="text" style="width:100px;"  readonly; ><br><br>
                  <HR>
                 </div></div></div>
                   <div class="col-lg-8">
             <p style="color: #000;">  Need Help? Contact on <a href="mailto:contact@dezinebox.io"> contact@dezinebox.io</a> <br>
Click to know <a href="#">PRICE MULTIPLYER </a></p>
              </div><!-- / .col-lg-8 -->
               <div class="col-lg-4 totals-group">
                <div class="totals-content">
                <div class="subtotal-group">
