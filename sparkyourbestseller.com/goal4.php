...
<body>
	...
	<section id="projects" style="padding: 0px;">
      ...
      <input id="Field3" style="margin-right:200px;"   name="goal" type="text" spellcheck="false" value=""   tabindex="3" placeholder="Enter your Goal" maxlength="80" required> 
					...
					<div id="challenging" >
						<label class="desc" id="title5" style="margin-top:50px"><img height="50px" src="img/direction.png" width="50px"></label>

						<p class='field required'><span class="input input--nao" style="margin-left:0px;"><label class="input__label input__label--nao" for="input-4"><span class="input__label-content input__label-content--nao">Is your goal challenging and will entail an audacious stretch?</span></label><br>
						<br><br>
						<input class="btn" style="background: transparent;border: 1px solid #fff;color: #fff;font-weight: bold;" id="is_challenging1" name="is_challenging1" type="button" value="Yes"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <input class="btn" style="background: transparent;border: 1px solid #fff;color: #fff;font-weight: bold;" id="is_challenging2" name="is_challenging2" type="button" value="No"></span>
						</p>
					</div>
					...
					<div id="inspiring" style="display:none" >
						...
						<p class='field required'><span class="input input--nao" style="margin-left:0px;"><label class="input__label input__label--nao" for="input-5"><span class="input__label-content input__label-content--nao">Does the goal really inspire you?</span></label><br><br>
						<input class="btn" style="background: transparent;border: 1px solid #fff;color: #fff;font-weight: bold;" id="is_inspiring1" name="is_inspiring1" type="button" value="Yes"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <input class="btn" style="background: transparent;border: 1px solid #fff;color: #fff;font-weight: bold;" id="is_inspiring2" name="is_inspiring2" type="button" value="No"></span>
						</p>
					</div>


					<div id="captured" style="display:none" >
						<label class="desc" id="title7" style="margin-top:50px"><img height="50px" src="img/finished.png" width="50px"></label>

						<p class='field required'><span class="input input--nao" style="margin-left:0px;"><label class="input__label input__label--nao" for="input-6"><span class="input__label-content input__label-content--nao">Does your goal capture the big picture instead of getting stuck in the micro?</span></label><br>
						<br>
						<br><br>
						<input class="btn" style="background: transparent;border: 1px solid #fff;color: #fff;font-weight: bold;" id="is_captured1" name="is_captured1" type="button" value="Yes"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <input class="btn" style="background: transparent;border: 1px solid #fff;color: #fff;font-weight: bold;" id="is_captured2" name="is_captured2" type="button" value="No"></span>
						</p>
					</div>
					...
					<div id="rework" style="display:none" >
						...
						<p class='field required'><span class="input input--nao" style="margin-left:0px;"><label class="input__label input__label--nao" for="input-7"><span class="input__label-content input__label-content--nao">Would you want to rework your goal?</span></label><br>
						<br>
						<input class="btn" style="background: transparent;border: 1px solid #fff;color: #fff;font-weight: bold;" id="want_rework1" name="want_rework1" type="button" value="Yes"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <input class="btn" style="background: transparent;border: 1px solid #fff;color: #fff;font-weight: bold;" id="want_rework2" name="want_rework2" type="button" value="No"></span>
						</p>
					</div>
					<br>
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <!--
...
-->
					 <a data-toggle="collapse" id="goal_submit" name="sub" style=" display: none; cursor:pointer"><img data-toggle="collapse" height="40px" id="sub" name="sub" onclick="return validate()" src="icons/right-arrow.png" width="40px"></a> <input name="submitted" type="hidden" value="1"><br>
					...
					<div class="collapse" id="Bravo" style="">
						...
						<div>
							<h4 style="color:#FFFFFF;">Bravo! Now, visualize you have achieved your goal and have started the journey of penning a bestseller...!</h4>
						</div>
					</div>
			...
			<a href="template.php"><input class="btn btn-primary yk_button_spark" id="spark" name="sub" style="float: right;" type="button" value="Let's Spark!">
			</a>
			<!-- </form> -->
			<br>
			<br>
