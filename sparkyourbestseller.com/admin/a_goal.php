...
<head>
        ...
        <!-- Title -->
        <title>Goals | Admin_#SparkYourBestseller</title>
        ...
        <div class="mn-content fixed-sidebar">
            ...
            <aside id="slide-out" class="side-nav white fixed">
                ...
                <ul class="sidebar-menu collapsible collapsible-accordion" data-collapsible="accordion">
                    ...
                    <li class="no-padding active "><a class="waves-effect waves-grey" href="a_goal.php"><i class="material-icons">settings_input_svideo</i>Goals</a>
                    </li>
            ...
            <main class="mn-inner">
                ...
                ?>
                                ...
                                <span class="card-title"><?php  echo "<h5>Total number of goals <b><u>".$rowcount."</u></b></h5>"; ?></span>
