...
<head>
        ...
        <!-- Title -->
        <title>Users | Admin_#SparkYourBestseller</title>
        ...
        <div class="mn-content fixed-sidebar">
            ...
            <aside id="slide-out" class="side-nav white fixed">
                ...
                <ul class="sidebar-menu collapsible collapsible-accordion" data-collapsible="accordion">
                    <li class="no-padding active"><a class="waves-effect waves-grey" href="index.php"><i class="material-icons">settings_input_svideo</i>Users</a>
                    </li>
 ...
 <?php
                ...
                {
                    $phon_query= "SELECT * FROM scollable where email= '".$r['email']."' and phone != '' ";

                   
                	 $res_phone = mysqli_query($connect, $phon_query );

                	 $row=mysqli_fetch_assoc($res_phone);
