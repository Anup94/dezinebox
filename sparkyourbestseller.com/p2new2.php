	 ...
	 <script language="javascript" type="text/javascript">
	  $(document).ready(function(){
	   ...
	   $("#name1").on('keyup',function(){
		...
		var len=my.length;
		if(len>=5){
		alert("Alphabets should not be greater then 5..!");
...
<?php
 ...
 ?>            
    ...
    <label class='label required' for='name' style="font-size:14px">Enter your Name?</label><br>
   ...
   <p class='field required'>
   <label class='label required' for='name' style="font-size:14px">What will be the sub-title that will explain the context?</label><br>
    <input class='text-input' id='name' name='title' title="add  15 alphabets " maxlength="15" required tabindex='1' type='text'>
  </p>
  
   <p class='field required'>
    <label class='label required' for='name' style="font-size:14px">What will be the name of your 'bestseller'?</label><br>
    <input class='text-input' id='name1' name='aname'  title="add  5 alphabets "  maxlength="10" required tabindex='1' type='text'>
  </p>
   <p class='field half'>
   <label class='label required' for='name' style="font-size:14px">Enter your Email Id?</label><br>
    <input class='text-input' id='name' name='email' title="add  15 alphabets " maxlength="15" required tabindex='1' type='email'>
  </p>
   <p class='field half'>
   <label class='label required' for='name' style="font-size:14px">Enter your Mobile Number?</label><br>
    <input class='text-input' id='name' name='phone' title="add  only integers " maxlength="10"  pattern="[0-9]{10}" required tabindex='1' type='text'>
  </p>
