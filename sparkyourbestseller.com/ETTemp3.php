...
<script type="text/javascript" src="jsc/script3.js"></script>    
 -->
 ...
 ?>            
   ...
   <?php
           ...
           // echo $check;
                ...
                $connect = mysqli_connect("localhost", "root", "", "spark");
			   ...
			   <p class='field required'>
                   ...
                   <span class="input input--nao">
					...
					<label class="input__label input__label--nao" for="input-1">
                        <span class="input__label-content input__label-content--nao">Craft a title that will capture your journey to conquer your goal</span>
					</label>
