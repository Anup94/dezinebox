 ...
 ?>            
   ...
   <?php
           ...
           // echo $check;
                ...
                $sq=mysqli_query($connect,"SELECT * FROM users WHERE  username='$log_username' and email='$check' LIMIT 1");
	...
	?>     
			   ...
			   <p class='field required'>
                   ...
                   <span class="input input--nao">
					<input class="input__field input__field--nao" type="text" id='name' name='title' maxlength="30" tabindex='1'/>
...
-->
   ...
   <p class='field required'>
       <span class="input input--nao">
					<input style=""  class="input__field input__field--nao" type="text" id='name1' name='sname' maxlength="80" tabindex='1' onfocus="onfocus_subtitle()" />
					...
					<svg class="graphic graphic--nao" width="300%" height="100%" viewBox="0 0 1200 60" preserveAspectRatio="none">
                      ...
                      <div style="margin-top:-20px;width:280px;color:white;" id="b">Pick up 5–7 word sub-title that will shine the spotlight your goal!</div>
   ...
   <p class='field required'>
       <span class="input input--nao">
                   ...
                   <div style="margin-top:-20px;width:280px;color:white;" id="c">Your have exceeded the character limit.Come Up with something snappy</div>
                 
  
             <p style="color: #fff">Max Size: 10MB</p>
            <input type="file" name="photo" id="photo" class="file_input" required onfocus="onfocus_email()" onchange="fileValidation()" style="margin-left: -15px;color: white;">
                <div id="loading_progress" style="color:white;"></div>
                <input type="submit" value="Submit" id="upload_btn" style="background-color: white;margin-bottom: 10px;display:none;">
            <iframe name="upload_frame" class="upload_frame"></iframe>



<!--             <input type="file" name="photo" id="photo" class="file_input" id="upload_btn">
 ...
 -->
            ...
            <script type="text/javascript">
              ...
              function onfocus_email(){
                ...
                if(title==''){
                  ...
                  if(author==''){
                    bootbox.alert({
                        message: "​You don’t want credit for your bestseller? Please fill the author name",
                        backdrop: true,
                        className: 'modal-style',
                        callback: function () {
         ...
         ?>
             ...
             <form action="upload_photo1.php?id=<?php echo $id;?>" method="post" enctype="multipart/form-data" target="upload_frame" onSubmit="submit_photo()" class="form">
			   <p class='field required'>
                   <span class="input input--nao">
					<input style=""  class="input__field input__field--nao" type="text" id='name' name='title' maxlength="30" tabindex='1' type='text'/>
					<label class="input__label input__label--nao" for="input-2">
						<span class="input__label-content input__label-content--nao">Craft a title that will capture your journey to conquer the goal</span>
					</label>
					<svg class="graphic graphic--nao" width="300%" height="100%" viewBox="0 0 1200 60" preserveAspectRatio="none">
   ...
   <p class='field required'>
       <span class="input input--nao">
					<input style=""  class="input__field input__field--nao" type="text" id='name1' name='sname' maxlength="55" onfocus="onfocus_subtitle()" tabindex='1'/>
					<label class="input__label input__label--nao" for="input-2">
						<span class="input__label-content input__label-content--nao">What will be the sub-title that will define the context?</span>
					</label>
					<svg class="graphic graphic--nao" width="300%" height="100%" viewBox="0 0 1200 60" preserveAspectRatio="none">
   ...
   Pick up 5–7 word sub-title that will shine the spotlight on your goal!
  </div>
  </p>
   <p class='field required'>
       <span class="input input--nao">
					<input class="input__field input__field--nao" type="text" id='name2' name='aname' maxlength="30" tabindex='1' onfocus="
          onfocus_subtitle()" />
					<label class="input__label input__label--nao" for="input-3">
						<span class="input__label-content input__label-content--nao">What will be the name of the author?</span>
					</label>
                    ...
                    <div id="c" style="margin-top:-20px;width:280px;color:white;" >Your have exceeded the character limit. Come up with something snappy</div>
    </p>               
   <p class='field half'>
       <span class="input input--nao">
   ...
   <p class='field half'>
       ...
       <span class="input input--nao">
                ...
                <p style="color: #fff">Max Size: 10MB</p>  
            <input type="file" name="photo" id="photo" class="file_input" onfocus="onfocus_file()" onchange="fileValidation()" style="margin-left: -18px;color:white;">
                <div id="loading_progress" style="color:white;"></div>
                <input type="submit" value="Submit" id="upload_btn"  style="display:none;">
            <iframe name="upload_frame" class="upload_frame"></iframe>
...
<!--
          <a href="gallery1.php?id=<?php echo $id;?>" vlink="#808080" alink="#FF0000">
            <input type="button" value="Go to Gallery">
          </a><br>
-->
</div>
