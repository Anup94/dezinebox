...
<script type="text/javascript" src="jsc/script2.js"></script>   
	...
	?>     
			   ...
			   <p class='field required'>
                   ...
                   <span class="input input--nao">
					<input style=""  class="input__field input__field--nao" type="text" id='name' name='title' maxlength="30" tabindex='1'/>
...
-->
   ...
   <p class='field half'>
       ...
       <span class="input input--nao">
                ...
                <p style="color: #fff">Max Size: 10MB</p>  
            <input type="file" name="photo" id="photo" class="file_input" onfocus="onfocus_file()"  style="margin-left: -18px;color: white;" onchange="fileValidation()">
            <!-- onchange="document.getElementById('upload_btn').click()" -->
