...
$sname=mysqli_real_escape_string($con,$_SESSION['sname']);
$aname=mysqli_real_escape_string($con,$_SESSION['aname']);

$sql = "INSERT INTO scollable (temp_id,title,sname,aname,name,email,whenneed) VALUES ('{$_SESSION['id']}','$title','$sname','$aname','$src','{$_SESSION['email']}',now())";
//die($sql);
