				                ...
				                while($r= mysqli_fetch_array($res))
				                {
				                    ...
				                    if($id==1)
				                    {
				                        ...
				                        <div class="bk-info">
				                           ...
				                           <a id="btn-Convert-Html2Image" href="#"> <img src="icons/download-button.png" width="40px" height="40px" title="Download" style="margin-left: 15px;"></img></a>
                                            
				                            <a href="goal.php"><img src="icons/add-button.png" width="40px" height="40px" title="Add Template" style="margin-left: 15px;"></img></a>
				                            
                                            <a href="save.php?id='.$r["id"].'"><img src="icons/save.png" width="40px" height="40px" title="Save" style="margin-left: 15px;"></img></a>
                                            </div>';
				                    ...
				                    echo '<li>';
				                        ...
				                        <div class="bk-info">
				                         ...
				                         <a id="btn-Convert-Html2Image" href="#"> <img src="icons/download-button.png" width="40px" height="40px" title="download" style="margin-left: 15px;"></a></img>
...
<!--
			<div class="fb-share-button" data-href="http://sparkthebestseller.com/gallery1.php?id='.$id.'" data-layout="button_count" data-size="small" data-mobile-iframe="true"><a class="fb-xfbml-parse-ignore" target="_blank" href="https://www.facebook.com/sharer/sharer.php?u=http%3A%2F%2Fsparkthebestseller.com%2Fgallery1.php%3Fid%3D'.$id.'&amp;src=sdkpreparse">Share</a></div>
            
			<div class="g-plusone" data-size="medium" data-annotation="inline" data-width="300"></div>
			<script src="//platform.linkedin.com/in.js" type="text/javascript"> lang: en_US</script>
			<script type="IN/Share" data-url="http://sparkthebestseller.com/gallery1.php?id='.$id.'#" data-counter="top"></script>
