...
<?php
 ...
 ?>            
    ...
    <label class='label required' for='select' >Position:</label>
    <select name="sname"  class='select' id='select' tabindex='13' required>
      <option selected value=''></option>
      <option value='Team Management'  style="color:#000000">Team Management</option>
      <option value='Boss Management'  style="color:#000000">Boss Management</option>
      <option value='Time Management'   style="color:#000000">Time Management</option>
	  <option value='Carrier Development' style="color:#000000">Carrier Development</option>
	  <option value='Personality Development'  style="color:#000000">Personality Development</option>
	  <option value='Parenting'  style="color:#000000">Parenting</option>
	  <option value='Health & Wellness'  style="color:#000000">Health & Wellness</option>
	  <option value='Financial Planning'  style="color:#000000">Financial Planning</option>
	  <option value='Relationship'  style="color:#000000">Relationship</option>
	  
    </select>
  </p>
            <p class='field required'>
    <label class='label required' for='name'>Enter your Goal:</label>
   ...
   <p class='field required'>
   <label class='label required' for='name'>Enter Title of the Book:</label>
    <input class='text-input' id='name' name='title' title="add  15 alphabets " maxlength="15" required tabindex='1' type='text'>
  </p>
  
   <p class='field half'>
    <label class='label required' for='name'>Enter the Author Name:</label>
    <input class='text-input' id='name' name='aname'  title="add  5 alphabets "  maxlength="10" required tabindex='1' type='text'>
  </p>
