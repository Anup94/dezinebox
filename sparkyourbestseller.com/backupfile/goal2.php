...
$c=$_POST['email'];
$d=$_POST['phone'];
$q="INSERT INTO goal(area,goal,email,phone) values('$a','$b','$c','$d')";
$r=mysql_query($q);
if($r)
{
...
<form action="#" method="post" enctype="multipart/form-data">
 ...
 <div>
   ...
   <br />
    <div >
	<label class="desc" id="title1" for="Field1"><img src="img/magnifier_white.png" height="50px" width="50px"></label>
    <div>
   ...
   <label class="desc" id="title3" for="Field3">
      <img src="img/ruler_white.png" height="50px" width="50px">
    </label>
    <div>
	...
	<div id="email">
   <label class="desc" id="title3" for="Field3">
     <img src="img/user_white.png" height="50px" width="50px">
    </label>
    <div>
      <input id="Field2" style="margin-right:200px;" name="email" type="email" spellcheck="false" value=""  tabindex="3" placeholder="Email Id" maxlength="30" required> 
   </div>
	...
	<div id="phone">
   <label class="desc" id="title3" for="Field3">
      <img src="img/trophy-cup-on-lectern-of-podium_white.png" height="50px" width="50px">
    </label>
    <div>
      <input id="Field4" style="margin-right:200px;" name="phone" type="text" spellcheck="false" value=""  tabindex="3" placeholder="Mobile Number" maxlength="10"  pattern="[0-9]{10}" title="add only integer" required> 
   </div>
  
    </div>
	
	 <div  id="bravo">
	<h4 style="background-color:#FFFFFF; font-size:24px " >Bravo! Now, visualize you have achieved your goal and have started the journey of penning a bestseller...!</h4>
    </div>
