...
-->
        ...
        <div class="col-xs-7" style="padding-right: 0px" >
                  ...
                  <div class="row">
                       <div style="color: #ffffff;font-size: 20px;padding-top: 30px">
                         <strong style="color: orange;font-size: 24px;margin-left: 40px;">Details : </strong>
                       </div>                
                  </div>
    ...
    <label class='label required' for='name'style="color:white;font-size: 12px;font-family: 'Abel', sans-serif;">What will be the name of your 'bestseller'?</label>
    <input class='text-input' id='name' name='title'  title="Pick a 2-3 word creative name. Go ahead, inspire the world! "  maxlength="20" required tabindex='1' type='text'>
  </p>
  <p class='field required'>
    <label class='label required' for='name' style="color:white;font-size: 12px;font-family: 'Abel', sans-serif;">What will be the Sub-Title that will explain the context?</label>
    <input class='text-input' id='name' name='sname' title="The 4–5 word sub-title can shine the spotlight your dream goal!" maxlength="50" required tabindex='1' type='text'>
  </p>
  
   
   <p class='field required'>
    <label class='label required' for='name' style="color:white;font-size: 12px;font-family: 'Abel', sans-serif;">What will be the author name of the book?</label>
    <input class='text-input' id='name' name='aname' title="Pick a 2-3 word creative name " maxlength="30" required tabindex='1' type='text'>
  </p>
   
   <p class='field required'>
   <label class='label required' for='name' style="color:white;font-size: 12px;font-family: 'Abel', sans-serif;">Enter your Email id?</label>
    <input class='text-input' id='name' name='email' title="This will be your User Name " maxlength="55" required tabindex='1' type='text'>
  </p>
