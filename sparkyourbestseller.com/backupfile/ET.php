...
<?php
 ...
 ?>            
        ...
        <div class="col-xs-7" style="padding-right: 0px" >
                  ...
                  <div class="row">
                       <div class="col-xs-8 " style="color: #ffffff;font-size: 20px;padding-top: 10px;">
                         <strong style="color: orange;font-size: 24px; margin-left:100px;">Details</strong>
                       </div>                
                  </div>
...
<!--   <label class='label required' for='name' style="font-size:10px">Enter your Mobile Number?</label><br>-->
  ...
  <?php
        ...
        ?>
            ...
            <span class="upload_btn" onClick="show_popup('popup_upload')" style="margin-left:100px;">Upload Image</span>
