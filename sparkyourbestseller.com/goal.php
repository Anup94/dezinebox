		...
		<script type="text/javascript">
		        $(function(){
		            ...
		            $('#want_rework2').click(function(){
		                ...
		                else if (insp_show!=true) {
		                	$('#inspiring').show(500);
		                	insp_show=true;
		                }
		                else if (capt_show!=true) {
		                	 $('#captured').show(500);
		                	 capt_show=true;
		                }
		                else{
...
function category_entered(){
	...
	<body>
		...
		<section id="projects " class="phon_section" style="padding: 0px;  ">
				...
				<div class="col-xs-12 yk_panel_background" style="min-height:0px;">
					<form action="template.php" enctype="multipart/form-data" id="goal_form" method="post" name="goal_form">
						...
						<div id="new_area" style="display:none;">
							...
							<label onclick="category_entered()" style="cursor: pointer;" ><img style="max-width:13%;margin: 10% 60% 0% 0%;" src="img/arrow.png"    ></label>
						</div>

						<div id="goal0" style="">
							<label class="desc" id="title3" style="margin-top:40px"><img height="50px" src="img/ruler_white.png" width="50px"></label>
							<p class='field required'>
								<span class="input input--nao" style="margin-left:0px;"><input  class="input__field input__field--nao" id='Field3' name='goal' onfocus="$('html, body').animate({scrollTop:$(document).height()}, 'slow');" spellcheck="false" style="margin-right:200px;" tabindex="3" type="text" value=""> <label class="input__label input__label--nao" for="input-2"><span style="margin: -2.5% 0% 0% 0%;" class="input__label-content input__label-content--nao">Define your goal ('what' do you want to achieve & by 'when')<br></span></label> <svg class="graphic graphic--nao" height="100%" preserveaspectratio="none" viewbox="0 0 1200 60" width="300%">
								<path d="M0,56.5c0,0,298.666,0,399.333,0C448.336,56.5,513.994,46,597,46c77.327,0,135,10.5,200.999,10.5c95.996,0,402.001,0,402.001,0">
							</p>
							<label onclick="goal_entered()" style="cursor: pointer;" ><img style="max-width:13%;margin: 10% 60% 0% 0%;" src="img/arrow.png" ></label>
						</div>
...
-->
				...
				<a href="template.php"><input class="btn btn-primary yk_button_spark" id="spark" name="sub" style="float: right; font-size: 18px; color: #fff;" type="button" value="Let's Spark!"></a> <!-- </form> -->
				<br>
				<br>
			</div>
		</section>

	<footer style=" margin: 0% 0% 15% 0%;">
