...
<link rel="stylesheet" href="crop/css/style.css" />
<link rel="stylesheet" href="crop/css/jquery.Jcrop.min.css" type="text/css" />
<script type="text/javascript" src="crop/js/jquery.min.js"></script>
<script src="crop/js/jquery.Jcrop.min.js"></script>
<script type="text/javascript" src="crop/js/script.js"></script>
</head>

<body>
    <div class="container">
        <div class="header">
            <img src="crop/images/BeWebDeveloper.png" />
        </div><!-- header -->
