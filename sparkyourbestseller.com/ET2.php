...
-->
  ...
  <div id="c" class="auth">
   ...
   Your are Exceeding Character Limit
  </div>
                   
-->
             <!--div class="row" style="margin-top: 10px;"-->
      <div class='col-md-12'>
               <div id="popup_upload" style="width:100%">
        <div class="form_upload">
            <span class="close" onClick="close_popup('popup_upload')">x</span>
            <h2>Upload Image</h2>
            <input type="file" name="photo" id="photo" class="file_input" accept="image/*" onfocus="onfocus_file()"  style="color:white;">

            <!-- onchange="document.getElementById('upload_btn').click()" -->
                <div id="loading_progress" style="color:white;"></div>
                <input type="submit" value="Upload" id="upload_btn"  style="">
         ...
         ?>
             ...
             <form action="upload_photo1.php?id=<?php echo $id;?>" method="post" enctype="multipart/form-data" target="upload_frame" onSubmit="submit_photo()" class="form" onSubmit="return Checkfiles(this);">
         <p class='field required'>
                   <span class="input input--nao">
          <input class="input__field input__field--nao" type="text" id='name' name='title' maxlength="40" required tabindex='1' type='text'/>
          <label class="input__label input__label--nao" for="input-2">
            <span class="input__label-content input__label-content--nao">What will be the title of your bestseller?</span>
          </label>
...
-->
   ...
   <p class='field required'>
       <span class="input input--nao">
          <input class="input__field input__field--nao" type="text" id='name1' name='sname' maxlength="55" tabindex='1'/>
          <label class="input__label input__label--nao" for="input-2">
            <span class="input__label-content input__label-content--nao">What will be the sub-title that explain's the context?</span>
          </label>
          <svg class="graphic graphic--nao" width="300%" height="100%" viewBox="0 0 1200 60" preserveAspectRatio="none">
       ...
       <div id="b" style="margin-top:-20px;width:280px;color:white;" >Pick up 5–7 word sub-title that can shine the spotlight your dream goal!</div>
...
-->
   ...
   <p class='field half'>
       <span class="input input--nao">
          <input class="input__field input__field--nao" type="text" id='nam3' name='email' maxlength="30" pattern="[A-Za-z0-9._%+-]+@[A-Za-z0-9.-]+\.[A-Za-z]{2,3}$" required tabindex='1'/>
          <label class="input__label input__label--nao" for="input-3">
...
<!--   <label class='label required' for='name' style="font-size:10px">Enter your Email Id?</label><br>-->
   ...
   <p class='field half'>
       ...
       <span class="input input--nao">
          <input class="input__field input__field--nao" type="text"  id='name4' name='phone' maxlength="12" required tabindex='1'  pattern="[0-9]{10}" required tabindex='1'/>
          <label class="input__label input__label--nao" for="input-3">
...
<!--   <label class='label required' for='name' style="font-size:10px">Enter your Mobile Number?</label><br>-->
    <!--input class='text-input' id='name4' name='phone' title="Enter your Mobile Number? " maxlength="10"  pattern="[0-9]{10}" required tabindex='1' type='text' value="Enter your Mobile Number?" onclick='javascript: this.value = ""'-->
        ...
        <div class="form_upload">
            <span class="close" onClick="close_popup('popup_upload')">x</span>
            <h2>Upload Image </h2>
            <input type="file" name="photo" id="photo" class="file_input" style="margin-left: -18px"  onfocus="onfocus_file()" style="color:white;">
  ...
  <?php
    ...
    <div id="popup_crop" class="row">
        <div class="form_crop">
            ...
            <a  href="gallery1.php?id=<?php echo $id;?>"> <input type="button" value="Crop Image" id="crop_btn" onClick="crop_photo()" /></a>
            </form>
        </div>
    </div>
