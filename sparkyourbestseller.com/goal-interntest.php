	...
	<script>
		$(document).ready(function(){
			$(".btn").hover(function(){
				...
				$(this).css({ "border": "1px solid #00bdff", "color": "#fff" });
			});
		});
	...
	<section id="projects" style="padding: 0px;">
      ...
      <input id="Field3" style="margin-right:200px;"   name="goal" type="text" spellcheck="false" value=""   tabindex="3" placeholder="Enter your Goal" maxlength="80" required> 
					...
					<div id="challenging" >
						...
						<br><br>
						<input class="btn" style="background: transparent;border: 1px solid #00bdff;color: #fff;font-weight: bold;" id="is_challenging1" name="is_challenging1" type="button" value="Yes"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <input class="btn" style="background: transparent;border: 1px solid #00bdff;color: #fff;font-weight: bold;" id="is_challenging2" name="is_challenging2" type="button" value="No"></span>
						</p>
					</div>
					...
					<div id="inspiring" style="display:none" >
						...
						<input class="btn" style="background: transparent;border: 1px solid #00bdff;color: #fff;font-weight: bold;" id="is_inspiring1" name="is_inspiring1" type="button" value="Yes"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <input class="btn" style="background: transparent;border: 1px solid #00bdff;color: #fff;font-weight: bold;" id="is_inspiring2" name="is_inspiring2" type="button" value="No"></span>
						</p>
					</div>
					...
					<div id="captured" style="display:none" >
						...
						<br><br>
						<br><br>
						<input class="btn" style="background: transparent;border: 1px solid #00bdff;color: #fff;font-weight: bold;" id="is_captured1" name="is_captured1" type="button" value="Yes"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <input class="btn" style="background: transparent;border: 1px solid #00bdff;color: #fff;font-weight: bold;" id="is_captured2" name="is_captured2" type="button" value="No"></span>
						</p>
					</div>
					...
					<div id="rework" style="display:none" >
						...
						<br>
						<input class="btn" style="background: transparent;border: 1px solid #00bdff;color: #fff;font-weight: bold;" id="want_rework1" name="want_rework1" type="button" value="Yes"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <input class="btn" style="background: transparent;border: 1px solid #00bdff;color: #fff;font-weight: bold;" id="want_rework2" name="want_rework2" type="button" value="No"></span>
						</p>
					</div>
					<br>
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <!--
...
-->
			...
			<a href="template.php"><input class="btn btn-primary yk_button_spark" id="spark" name="sub" style="float: right;    font-size: 18px;" type="button" value="Let's Spark!">
			</a>
			<!-- </form> -->
			<br>
			<br>
