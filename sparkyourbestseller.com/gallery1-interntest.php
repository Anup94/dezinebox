...
<head>
	...
	<meta name="og:image" content="http://test.sparkthebestseller.com/img/sparkbook<?php echo $id; ?>.png"/>
	<meta name="og:title" content="SparkTheBestSeller" />
	<meta name="og:description" content="Let's Spark. Create your own books." />
	<meta name="og:url" content="http://test.sparkthebestseller.com/gallery1.php?id=<?php echo $id; ?>"/>
                        ...
                        onrendered: function (canvas) {
                               ...
                               $.ajax({
				                    ...
				                    success:function(data){
				                    	window.location = 'sgallery-interntest.php?id='+id+'&tid='+tid;
				                    	//alert('Success!');
				                    }
				              });
                            }
