...
<?php
 ...
 ?>            
        ...
        <div class="col-xs-7" style="padding-right: 0px" >
               ...
               <form action="upload_photo.php?id=<?php echo $id;?>" method="post" enctype="multipart/form-data" target="upload_frame" onsubmit="submit_photo()">
        ...
        <div class="form_upload">
            ...
            <iframe name="upload_frame" class="upload_frame"></iframe>
             ...
             <div class="row" style="margin-top: 10px;margin-bottom: 5px">
               ...
               <div class="col-xs-4" style="color: #ffffff;font-size: 19px; margin-bottom: 25px">User Name</div>
    ...
    <div class="col-xs-12 yk_panel_bottom_background">
      <div class="row">
       ...
       <div class="col-lg-2 col-md-2 col-xs-3  yk_button_panel_bottom ">
         ...
         <a href="quiz.php?id=<?php echo $id;?>"><img src="img/1.png" class="section1_icon yk_top_margin15"></a>
