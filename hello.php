...
<body background="assets/images/cube/newshade.jpg">
...
<br><br><br>
<div class="col-md-6 ft-item wow fadeInUp"  data-wow-duration="1s" style="height: 412px;">
...
<div class="col-md-4"  data-wow-duration="1s" style="height: 412px;">
<br><br><a href="partners.php" style="margin-left: 150px;">Partners</a><br><br><br>
<div class="viewport">
   <div class="cube3 cube"  >
    ...
    <br><br><a href="partners.php">Partners</a> <a href="d.php" style="margin-left: 200px;">Dezine</a>
</div>
...
<!-- ========== Scripts ========== -->
	<nav>
		<ul class="cd-vertical-nav">
			<li><a href="hello1.php" class="cd-prev inactive">Next</a></li>
			<li><a href="hello1.php" class="cd-next">Prev</a></li>
		</ul>
	</nav>
<script src="assets/js/cube.js"></script><!-- Resource jQuery -->
