...
if(!empty($result->boxTypeId) && !empty($result->constTypeId) && !empty($result->selectedArea)
  ...
  $categoryOptn =$result->categoryOption;

  $ele = substr_count($categoryOptn,",");
  $ele= $ele + 1; 
...
| <?php 
 ...
 <?php 
                  $formEle=array("price"=>"");
                  foreach ($formEle as $key => $value) {
                    echo "<tr><td>".$value."</td><td>".$result->price."</td></tr>";
                  }
...
{   case '0-250':echo "1 " ; break;
    case '250-500':echo "1.5 " ; break;
     case '500-1000':echo "2 " ; break;
      case '1000-1500':echo "2.5 " ; break;
       case '1500-2000':echo "3 " ; break;
        case '2000+':echo "1 " ; break;
}
}?> 
                  ...
                  <label style="float: right"> <?php 
                                if($result->constTypeId == 1 )
                {echo ($pricee=$result->price*$ele) ;}
else{
switch ($result->selectedArea)
{   case '0-250':$pricee=$result->price*1 ; echo ($result->price*1)  ; break;
    case '250-500':$pricee=$result->price*1.5 ; echo ($result->price*1.5)  ; break;
     case '500-1000':$pricee=$result->price*2 ;echo ($result->price*2)  ; break;
      case '1000-1500':$pricee=$result->price*2.5 ; echo ($result->price*2.5) ; break;
       case '1500-2000':$pricee=$result->price*3 ; echo ($result->price*3)  ; break;
        case '2000+':$pricee=$result->price*1 ; echo "on request"  ; break;
}
}
...
// {   case '0-250':$pricee=$result->price*$ele ; echo ($result->price*$ele)  ; break;
//     case '250-500':$pricee=$result->price*$ele ; echo ($result->price*$ele)  ; break;
//      case '500-1000':$pricee=$result->price*$ele ;echo ($result->price*$ele)  ; break;
//       case '1000-1500':$pricee=$result->price*$ele ; echo ($result->price*$ele) ; break;
//        case '1500-2000':$pricee=$result->price*$ele ; echo ($result->price*$ele)  ; break;
//         case '2000+':$pricee=$result->price*1 ; echo "on request"  ; break;
// }
              ...
              <div class="col-lg-4 col-md-12 totals-group">
                ...
                <div class="subtotal-group">
                  <h6> &nbsp &nbsp &nbsp &nbsp &nbsp  Total <small>( before  taxes )</small>&nbsp </h6>
                   &nbsp &nbsp &nbsp &nbsp &nbsp   <label style="float: right"> <?php 
                   echo   $pricee  ;
//                   $formEle=array("price"=>"");
...
//                   }
                ...
                ?></label><br><br>
                 &nbsp &nbsp &nbsp &nbsp &nbsp   
                  <h6>&nbsp (-) Promo Code :</h6> &nbsp &nbsp &nbsp &nbsp &nbsp   &nbsp &nbsp &nbsp <input type="text" name="pcode" id="pcode" style="float: right;">
                  <div class="col-lg-10"></div>&nbsp<div class="col-lg-1">
                  <br><button id="pcheck" class="btn checkout-btn" style="padding: 5px; flo">&nbsp Apply &nbsp </button></div><br><br>
                </div>
