 <!-- Item 1 -->
  ...
  h5{
    font-size: 0.8em;
              ...
              <div class="col-lg-3 col-md-6 mb-sm-50" style="margin-left: 15%"><h4>ethnic</h4>  <br><a href="get-your-box.php?categoryId=<?php echo $categoryId;?>&constTypeId=<?php echo $constTypeId;?>&categoryOption=<?php echo urlencode($categoryOption);?>&subCategoryOption=<?php echo urlencode('Ethnic');?>">
              ...
              <!-- Item 2 -->
              <div class="col-lg-3 col-md-6 mb-sm-50"> <h4>Contemporary</h4>  <br><a href="get-your-box.php?categoryId=<?php echo $categoryId;?>&constTypeId=<?php echo $constTypeId;?>&categoryOption=<?php echo urlencode($categoryOption);?>&subCategoryOption=<?php echo urlencode('Contemporary');?>">
              ...
              <!-- Item 4 -->
              <div class="col-lg-3 col-md-6 mb-sm-50 portfolio-item" style="margin-left: 15%">  <h4>Rustic</h4> <br> <a href="get-your-box.php?categoryId=<?php echo $categoryId;?>&constTypeId=<?php echo $constTypeId;?>&categoryOption=<?php echo urlencode($categoryOption);?>&subCategoryOption=<?php echo urlencode('Rustic');?>">
              ...
              <div class="col-lg-3 col-md-6 mb-sm-50 portfolio-item"><h4>Eclectic</h4> <br> <a href="get-your-box.php?categoryId=<?php echo $categoryId;?>&constTypeId=<?php echo $constTypeId;?>&categoryOption=<?php echo urlencode($categoryOption);?>&subCategoryOption=<?php echo urlencode('Eclectic');?>">
              ...
              <div class="col-lg-3 col-md-6 mb-sm-50 portfolio-item"><h4>ShabbyChic</h4> <br> <a href="get-your-box.php?categoryId=<?php echo $categoryId;?>&constTypeId=<?php echo $constTypeId;?>&categoryOption=<?php echo urlencode($categoryOption);?>&subCategoryOption=<?php echo urlencode('ShabbyChic');?>">
