...
<!-- 
              ...
              <div class="col-lg-12 col-md-12 mb-sm-50" >
                <div class="ft-item wow fadeInUp" data-wow-duration="1s">
                  ...
                  <h4 style="font-size: 1.5em;">PRIVACY POLICY</h4>
                  <p style="color: #777"><blockquote style="color: #000;">
                    This Privacy Policy applies to www.Dezinebox.io (Website), which is owned and operated by Dezinebox or WE. The Website facilitates our various design products i.e. design boxes offered on the website and related services (collectively Services) to product partners & design partners. <br><br>

                    This Privacy Policy describes the information that We collect from the users (including partners and customers), how We collect this information (directly or through third parties or which is automatically generated, when you interact with our Website and through our mobile application (Mobile App)) in future and what We do with it after We collect it.<br><br>

                    Dezinebox is strongly committed to protecting the privacy of its Users and has taken all necessary and reasonable measures to protect the confidentiality of the User information and its transmission through the World Wide Web<br><br>

                    This privacy policy (“Private Policy”) describes how we may use and disclose personally identifiable information that we may collect about you through the Website (“Personal Information”). We insist upon the highest standards for secure transactions and customer information privacy. Please read the following statement to learn about our information gathering and dissemination practices<br><br>
                  ...
                  Depending on the nature of your inquiry or activities on the website especially while you are buying the online boxes offered by Dezinebox, we may also obtain information about your space like pictures, map, address, area, FSI, budget, themes and also the payment details for making payment towards buying the online dezinebox’s.<br><br>

                  We also enquire about professional experiences, products, services, catalogues offered by you and details of your company & also the projects done by you. Providing this Information is necessary for performance of the services and functionalities offered by the website. If you decline to provide the requisite Personal Information, we may not be able to provide necessary business & services to you.<br><br>

                  We collect some Information from All Visitors to Our Website: Like many online services, we use technologies like session and persistent cookies, web beacons (tiny image files on web pages that communicate information about the page viewer to the beacon owner), log data, and third-party analytics services to collect and analyze information about all users of our Services This includes things like User search preferences, interaction with content on our Website, and location. <br><br>
                  ...
                  We may disclose Personal Information to our affiliates/partnets in your local jurisdiction or other locations as necessary or appropriate to provide the product or service you requested, to contact you in connection with product or service offerings, or for other legitimate business purposes. The names and addresses of our affiliates are published along with our design, products and services on www.Dezinebox.io portal or with the design provided to you or will be communicated to you during the course of the time.<br><br>

                  We may disclose information to companies and individuals we employ to perform business functions and services on our behalf. Such functions may include hosting our Web servers, analyzing data, providing legal, accounting and marketing services, and providing other support services. All such parties will be under obligation to maintain the security and confidentiality of the Personal Information, and to process the data in accordance with our instructions.<br><br>
                  ...
                  This Policy is an electronic record in terms of Information Technology Act, 2000 and rules there under as applicable and the provisions pertaining to electronic records in various statutes as amended by the Information Technology Act, 2000. This electronic record is generated by a computer system and does not require any physical or digital signatures to make the terms of this policy binding.<br>
                  <br>

                  Dezinebox has made every effort to ensure that this Privacy Policy adheres with the applicable laws. The invalidity or unenforceability of any part of this Policy shall not prejudice or affect the validity or enforceability of the remainder of this Policy.
                  <br><br>
