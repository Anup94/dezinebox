...
var viewport = new Viewport({
  element: document.getElementsByClassName('cube2')[0],
  fps: 20,
  sensivity: .1,
  sensivityFade: .93,
  speed: 2,
...
var viewport = new Viewport({
  element: document.getElementsByClassName('cube3')[0],
  fps: 20,
  sensivity: .1,
  sensivityFade: .93,
  speed: 2,
...
var viewport = new Viewport({
  element: document.getElementsByClassName('cube4')[0],
  fps: 20,
  sensivity: .1,
  sensivityFade: .93,
  speed: 2,
...
var viewport = new Viewport({
  element: document.getElementsByClassName('cube5')[0],
  fps: 20,
  sensivity: .1,
  sensivityFade: .93,
  speed: 2,
